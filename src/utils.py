...
from src import MERGE_TYPE_LIST, MERGE_METHOD_LIST, MERGE_METHOD_STATIC_LIST
from src.dataset.registry import tasks_8, tasks_20
...
def get_dir_dict(config: DictConfig, is_ta_mode: bool) -> dict:
    if is_ta_mode:
        ...
        weight_root = os.path.join(
            *_weight_root[:-1], _weight_root[-1] + "_TA")
